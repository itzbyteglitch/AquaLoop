    ...
    return (
      <main
        ...
        className={cn(
          ...
          "m-auto max-w-[calc(100%-16rem)] md:peer-data-[variant=inset]:m-auto md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-auto md:peer-data-[variant=inset]:mr-auto",
